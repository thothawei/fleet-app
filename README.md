...
**目前**：`flutter analyze` 無 issue、`flutter test` **383 passed**（51 個測試檔，2026-07-30 實跑）。
~~377 passed~~／~~361 passed~~／~~356 passed~~／~~351 passed~~／~~339 passed~~ 是漏更新的舊數字——**這一行請跟著最後一次實跑一起改**。
