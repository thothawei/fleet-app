...
**目前**：`flutter analyze` 無 issue、`flutter test` **444 passed**（57 個測試檔，2026-08-01 實跑）。
~~440 passed~~／~~434 passed~~／~~425 passed~~／~~414 passed~~／~~383 passed~~／~~377 passed~~／~~361 passed~~／~~356 passed~~／~~351 passed~~／~~339 passed~~ 是漏更新的舊數字——**這一行請跟著最後一次實跑一起改**。
